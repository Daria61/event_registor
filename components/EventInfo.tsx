  ...
  return (
    <>
        ...
        <div className="flex gap-2 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-[12px]">
              Үлдсэн суудал : {totalSeats - count}
            </p>
          </div>
        </div>
        <div className="flex gap-2 items-center">
      ...
      <div className="mt-10">
        ...
        <strong>
          {" "}
          өдөрлөгийн дараа мэргэжлийн багш нараас ганцаарчилсан зөвлөгөө үнэ
        ...
        <br />
        Нээлттэй өдөрлөгийн хичээлдээ суугаад дэлхийн топ их сургуулиудад
        тэнцсэн сурагчдаас өргөдлийн явц болон ахлах ангийн сурагчид хийж болох
        хичээлээс гадуурх үйл ажиллагааны талаар илүү хэрэгтэй мэдээлэл аваарай.
        Мөн
        <strong>
          {" "}
          Австрали, Солонгос, Унгарын засгийн газрын тэтгэлэг болон Европын их
          сургуулиудын талаар сонирхсон асуултаа чөлөөтэй асууж, үнэгүй зөвлөгөө
          авах боломжтой.
        </strong>
        <br />
        <br />
        Хэрэв та эцэг эх, асран хамгаалагчтайгаа ирэх хүсэлтэй байгаа бол тэдний
        имейл утасны дугаарыг бичиж бүргүүлнэ үү!
      </div>
    </>
  );
};
